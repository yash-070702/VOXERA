...
import { Phone, VideoCamera, X, CaretRight, Star,Bell,Trash,Prohibit } from "phosphor-react";
...
const Contact = () => {
  ...
  return (
    <Box sx={{ width: 320, maxHeight: "100vh",overflowX:"hidden" }}>
      <Stack sx={{ height: "100%" }}>
        {/* --- HEADER --- */}
        <Box
          sx={{
